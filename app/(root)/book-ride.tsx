...
const BookRide = () => {
  ...
  return (
    <StripeProvider
      ...
      merchantIdentifier="merchant.uber-clone.com" // required for Apple Pay
      urlScheme="myapp" // required for 3D Secure and bank redirects
    >
      <RideLayout title="Book Ride">
        <>
          <Text className="font-JakartaSemiBold text-xl">Ride Information</Text>
          ...
          <View className="mt-3 flex w-full flex-col items-start justify-center rounded-3xl bg-general-600 px-5 py-3">
          ...
          <View className="mt-3 flex w-full flex-col items-start justify-center">
